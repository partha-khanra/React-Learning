  ...
  return (
    <>
      ...
      <div className="page-border" data-wow-duration="0.7s" data-wow-delay="0.2s">
        {/* <div className="top-border wow fadeInDown animated" style={{visibility: visible; animation-name: fadeInDown;}}></div> */}
        {/* <div className="right-border wow fadeInRight animated" style={{visibility: visible; animation-name: fadeInRight;"}}></div> */}
        {/* <div className="bottom-border wow fadeInUp animated" style={{visibility: visible; animation-name: fadeInUp;"}}></div> */}
          ...
          <div id="services" className="scrollto clearfix">
            ...
            <div className="row no-padding-bottom clearfix">
              ...
              <div className="col-3">
                ...
                <a href="#" data-videoid="UYJ5IjBRlW8" data-videosite="youtube" className="button video link-ightbox">
